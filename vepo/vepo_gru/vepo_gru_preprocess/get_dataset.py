...
def get_list(dire=None):
    ...
    for root, dirs, files in os.walk(dire):
        ...
        for file in tqdm(files):
            ...
            for mmsi in ship_data.keys():
                if mmsi in mmsi_lists :
                    for a in ship_data[mmsi]:
                        if len(a) > 15:
                            ten_percent_list.append(a)
...
def gen_dataset():
    directory = r'../../data_json'          #r'../data'
    save_dire = r'../../dataset_json/'      #r'../dataset/'
